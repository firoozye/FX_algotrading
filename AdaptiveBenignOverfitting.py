...
#TODO: Why isn't this a class member ?
...
# last row givens #
# TODO: Rename! givens_lastrow or similar. Make a member of some class
...
class QrRlS:
    ...
    def __init__(self,x,y,max_obs,ff, l):
        ...
        self.Q, self.R = self.Givens_Rotation(self.X.T)
    ...
    def givens_updown_date(self, update=True):
    ...
    def downdate(self, x, y):
        ...
        self.X = self.X[:, 1:]
        self.Q = self.givens_updown_date(False)
